...
if __name__ == "__main__":
    ...
    def calculator():
        ...
        The function prompts the user to enter their choice of operation and two numbers.
        It then performs the selected operation and prints the result.

        Note:
        - For addition, subtraction, multiplication, and division, the function uses helper functions `add`, `subtract`, `multiply`, and `divide` respectively.
        - For percentage calculation, the function uses a helper function `percentage`.
